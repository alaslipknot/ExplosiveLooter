...
namespace Animancer
{
    ...
    /// https://kybernetik.com.au/animancer/api/Animancer/IKeyHolder
    /// 
    ...
    public class Key : IKeyHolder
    {
        ...
        /// <summary>A <see cref="Key"/> is its own <see cref="IKeyHolder.Key"/>.</summary>
        Key IKeyHolder.Key => this;
        ...
        /// 
        public sealed class KeyedList<T> : IList<T>, ICollection where T : class, IKeyHolder
        {
            /************************************************************************************************************************/
