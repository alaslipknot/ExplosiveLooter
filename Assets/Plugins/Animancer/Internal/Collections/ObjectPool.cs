...
namespace Animancer
{
    ...
    public static class ObjectPool
    {
        ...
        public static List<T> AcquireList<T>() => ObjectPool<List<T>>.Acquire();
        ...
        public static HashSet<T> AcquireSet<T>() => ObjectPool<HashSet<T>>.Acquire();
        ...
        public static class Disposable
        {
            ...
            /// there are any or create a new one.
            /// </summary>
            public static IDisposable AcquireList<T>(out List<T> list) => ObjectPool<List<T>>.Disposable.Acquire(out list);
            ...
            /// there are any or create a new one.
            /// </summary>
            public static IDisposable AcquireSet<T>(out HashSet<T> set) => ObjectPool<HashSet<T>>.Disposable.Acquire(out set);
    ...
    public static class ObjectPool<T> where T : class, new()
    {
        ...
        public static T Acquire()
        {
            ...
            else
            {
                ...
                Debug.Assert(!(item is ICollection collection) || collection.Count == 0,
                    "A pooled collection is not empty." + ObjectPool.NotClearError);
