...
namespace Animancer
{
    ...
    public abstract class AnimancerNode : Key, IEnumerable<AnimancerState>, IEnumerator, IPlayableWrapper
    {
        ...
        /// <remarks>
        /// This method also applies the <see cref="Speed"/> if it was set beforehand.
        /// </remarks>
        ...
        /// hierarchy (including the root <see cref="AnimancerPlayable.Speed"/>) to determine the actual speed its
        ...
        public float EffectiveSpeed
        {
            get
            {
                var speed = Speed;
                if (Root != null)
                    speed *= ParentEffectiveSpeed * Root.Speed;
                return speed;
            }
            set
            {
                if (Root != null)
                    value /= ParentEffectiveSpeed * Root.Speed;
                Speed = value;
            }
        }
