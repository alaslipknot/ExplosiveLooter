...
namespace Animancer
{
    partial struct AnimancerEvent
    {
        ...
        public sealed partial class Sequence : IEnumerable<AnimancerEvent>
        {
            ...
            /// <summary>[Pro-Only]
            /// Replaces the <see cref="callback"/> of the event with the specified `name`.
            /// </summary>
            /// <exception cref="ArgumentException">There is no event with the specified `name`.</exception>
            /// <seealso cref="IndexOfRequired"/>
            ...
            /// <summary>[Assert-Conditional]
            /// Logs <see cref="OptionalWarning.DuplicateEvent"/> if the `oldCallback` is identical to the `newCallback` or
            /// just has the same <see cref="Delegate.Method"/>.
            /// </summary>
            [System.Diagnostics.Conditional(Strings.Assertions)]
